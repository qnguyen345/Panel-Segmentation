...
launcher = 'none'
load_from = '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/16_05_2025_08_12_59/best_coco_bbox_mAP_50_epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    type='FasterRCNN')
optim_wrapper = dict(
    optimizer=dict(lr=0.0001, type='AdamW', weight_decay=0.1),
    paramwise_cfg=dict(bypass_duplicate=True, norm_decay_mult=0.0),
    type='OptimWrapper')
param_scheduler = [
    dict(
...
visualizer = dict(
    ...
    vis_backends=[
        dict(
            save_dir=
            '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/16_05_2025_08_12_59',
            type='LocalVisBackend'),
    ])
work_dir = '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/16_05_2025_08_12_59'
