...
interval = 10
launcher = 'none'
load_from = '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/07_06_2025_18_57_11/best_coco_bbox_mAP_50_epoch_327.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    optimizer=dict(
        lr=0.006114513175734742,
        type='AdamW',
        weight_decay=0.049802997522779044),
    paramwise_cfg=dict(
...
visualizer = dict(
    ...
    vis_backends=[
        dict(
            save_dir=
            '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/07_06_2025_18_57_11',
            type='LocalVisBackend'),
    ])
work_dir = '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/07_06_2025_18_57_11'
