...
interval = 10
launcher = 'none'
load_from = '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/08_06_2025_09_26_28/best_coco_bbox_mAP_50_epoch_347.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    optimizer=dict(
        lr=0.00052240283327093,
        type='AdamW',
        weight_decay=0.018860032012967175),
    paramwise_cfg=dict(
...
visualizer = dict(
    ...
    vis_backends=[
        dict(
            save_dir=
            '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/08_06_2025_09_26_28',
            type='LocalVisBackend'),
    ])
work_dir = '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/08_06_2025_09_26_28'
