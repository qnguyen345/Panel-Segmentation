...
launcher = 'none'
load_from = '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/15_06_2025_21_32_42/best_coco_bbox_mAP_50_epoch_24.pth'
log_level = 'INFO'
...
visualizer = dict(
    ...
    vis_backends=[
        dict(
            save_dir=
            '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/15_06_2025_21_32_42',
            type='LocalVisBackend'),
    ])
work_dir = '/kfs2/projects/pvfleets24/repos/cv-dl-framework/runs/sol-searcher.v1i.coco-segmentation/15_06_2025_21_32_42'
